...
public class Demo {
    public static void main(String[] args) throws Exception {
         ...
         */
        Session aliceToBobSession = new Session(
                alice.getStore(),
                bob.getPreKey(),
                bob.getAddress()
        );
        ...
        //String msgToSend = HED.encryptHE("Input message string");
        String msgToSend = "Input message string";

        // "31,41,59,26,53".split(",")

        List<PreKeySignalMessage> toBobMessages = Arrays
                .stream(msgToSend.split(" "))
         ...
         */
        Session bobToAliceSession = new Session(
                bob.getStore(),
                alice.getPreKey(),
                alice.getAddress()
        );
        ...
        if (!fromAliceMessages.equals("Input message string")) {
